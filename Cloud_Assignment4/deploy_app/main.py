...
#     score, msg, color = health_score(cpu["current"], mem)
...
#     <body>
#         <h1>Cloud Run Health Dashboard</h1>
#         <h2>Score: {score}</h2>
#         <h3>{msg}</h3>

#         <div class="card">
#             <button onclick="fetch('/analyze').then(r=>r.json()).then(d=>alert(JSON.stringify(d,null,2)))">
#                 Run Analyze
#             </button>
